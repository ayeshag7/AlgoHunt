...
export const FAQ = () => {
  ...
  // Handle sending a question (placeholder logic)
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col items-center px-16 pt-20 pb-10 mt-8 bg-transparent max-md:px-5">
        <h2 className="max-md:text-2xl text-4xl text-white font-bold max-md:max-w-full text-center">
          Frequently Asked Questions
        </h2>
        <div className="mt-20 mb-16 w-full max-w-[1137px] max-md:px-8 px-32 max-md:mt-4 max-md:mb-8 max-md:max-w-full">
      ...
      <section className="flex flex-col items-center px-16 py-20 mb-12 bg-transparent max-md:px-5">
        <h2 className="max-md:text-2xl text-4xl text-white font-bold max-md:max-w-full text-center">
          Ask a Question
        </h2>
        <p className="mt-4 text-base text-center text-slate-400 max-md:max-w-full">
          Didn't find what you were looking for? Ask a question yourself!
        </p>
        <div className="flex justify-center items-center gap-x-4 mt-8 w-full max-w-[1137px] max-md:w-full">
          <input
            type="text"
            placeholder="Type your question here..."
            value={question}
            onChange={(e) => setQuestion(e.target.value)}
            className="w-[564px] max-md:w-full px-4 py-3 rounded-lg bg-gray-800 text-white placeholder-gray-500"
          />
          <button
            onClick={handleSendQuestion}
            className="px-8 py-3.5 bg-cyan-400 text-white rounded-lg"
          >
            Send
          </button>
        </div>
